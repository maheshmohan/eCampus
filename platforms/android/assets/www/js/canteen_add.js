...
$(document).ready(function() {
	...
	messagesRef = ref.child("data/csData");
	...
	$("#Register").click(function (e){
		 if(authData){
			...
			var can_address = $('#address').val();
			var can_country = $('#country').val();
			var can_postcode = $('#postcode').val();
			var can_gender = $('#gender').val();
			var can_password = $('#password').val();
			var can_rollnum = $('#rollnum').val();
			...
			//push data to canent DB
			messagesRef.push({first_name:first_name,Birth_Day:Birth_Day,Birth_Month:Birth_Month,Birth_Year:Birth_Year,father_name:father_name,email_id:email_id,mobile_no:mobile_no,can_address:can_address,can_country:can_country,can_postcode:can_postcode,can_gender:can_gender,can_designation:designation,can_ID:can_rollnum});
			
			//push data to login db
			loginRef.push({email:email_id,role:"c"});
			...
			window.alert("canteen staff Added");
