...
$(document).ready(function() {
	...
	messagesRef = ref.child("data/facultyData");
	...
	$("#Register").click(function (e){
		 if(authData){
			...
			var fac_address = $('#address').val();
			var fac_country = $('#country').val();
			var fac_postcode = $('#postcode').val();
			var fac_gender = $('#gender').val();
			var fac_password = $('#password').val();
			var fac_rollnum = $('#rollnum').val();
			var fac_dept = $("#dept").val();
			var adv_for = $("#adv").val();
			console.log(adv_for);
			...
			//push data to facent DB
			messagesRef.push({title:title,first_name:first_name,Birth_Day:Birth_Day,Birth_Month:Birth_Month,Birth_Year:Birth_Year,father_name:father_name,email_id:email_id,mobile_no:mobile_no,fac_address:fac_address,fac_country:fac_country,fac_postcode:fac_postcode,fac_gender:fac_gender,fac_designation:designation,fac_ID:fac_rollnum,fac_dept:fac_dept,advisor_for:adv_for});
			
			//push data to login db
			loginRef.push({email:email_id,role:"f"});
