...
$(document).ready(function() {
	...
	messagesRef = ref.child("data/studentData");
	...
	$("#Register").click(function (e){
		 if(authData){
			...
			var parent_mob = $('#parentmobileno').val;
			var email_id = $('#email').val();
			var mobile_no = $('#mobileno').val();
			var stud_address = $('#address').val();
			var stud_country = $('#country').val();
			var stud_postcode = $('#postcode').val();
			var stud_gender = $('#gender').val();
			var stud_password = $('#password').val();
			var stud_rollnum = $('#rollnum').val();
			var stud_dept = $("#dept").val();
			var stud_course = $("#course").val();
			var stud_advisor = $("#advisor").val();
			var advisor_mob = $("#advisormob").val();
			...
			//push data to student DB
			messagesRef.push({first_name:first_name,Birth_Day:Birth_Day,Birth_Month:Birth_Month,Birth_Year:Birth_Year,father_name:father_name,parent_mob:parent_mob,email_id:email_id,mobile_no:mobile_no,stud_address:stud_address,stud_country:stud_country,stud_postcode:stud_postcode,stud_gender:stud_gender,stud_mark:"0",stud_attendance:"0",stud_hostel:{hostel:"none",room:"none"},stud_rollnum:stud_rollnum,stud_dept:stud_dept,stud_course:stud_course,stud_advisor:stud_advisor,advisor_mob:advisor_mob});
			
			//push data to login db
			loginRef.push({email:email_id,role:"s"});
